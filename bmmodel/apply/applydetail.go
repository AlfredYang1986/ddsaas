...
type BmApplyDetail struct {
	...
	Reservable   reservable.BmReservable `json:"Reservable" jsonapi:"relationships"`
}
...
func (bd *BmApplyDetail) ResetIdWithId_() {
	bmmodel.ResetIdWithId_(bd)
}

func (bd *BmApplyDetail) ResetId_WithID() {
...
func (bd *BmApplyDetail) QueryObjectId() bson.ObjectId {
	return bd.Id_
}

func (bd *BmApplyDetail) QueryId() string {
	return bd.Id
}

func (bd *BmApplyDetail) SetObjectId(id_ bson.ObjectId) {
	bd.Id_ = id_
}

func (bd *BmApplyDetail) SetId(id string) {
	bd.Id = id
}
 ...
 *------------------------------------------------*/
func (bd BmApplyDetail) SetConnect(tag string, v interface{}) interface{} {
	switch tag {
	case "Applyee":
	...
	case "Reservable":
		bd.Reservable = v.(reservable.BmReservable)
	case "Kids":
		var rst []kid.BmKid
...
func (bd BmApplyDetail) QueryConnect(tag string) interface{} {
	return bd
}
...
func (bd *BmApplyDetail) InsertBMObject() error {
	return bmmodel.InsertBMObject(bd)
}

func (bd *BmApplyDetail) CoverBMObject() error {
	return bmmodel.CoverOne(bd)
}

func (bd *BmApplyDetail) FindOne(req request.Request) error {
	return bmmodel.FindOne(req, bd)
}

func (bd *BmApplyDetail) FindCount(req request.Request) (int, error) {
	return bmmodel.FindCount(req)
}

func (bd *BmApplyDetail) UpdateBMObject(req request.Request) error {
	return bmmodel.UpdateOne(req, bd)
}

func (bd *BmApplyDetail) ReSetProp() error {
...
func (bd *BmApplyDetail) reSetApplyee() error {
...
func (bd *BmApplyDetail) reSetYard() error {
...
func (bd *BmApplyDetail) reSetReservable() error {
...
func (bd *BmApplyDetail) reSetKids() error {
